...
--
-- Servidor: 127.0.0.1
-- Servidor MySQL: 9.7.2
--
-- Base de datos: `micropsev2`
-- Contraseñas demo de todos los usuarios: 123456 (hash bcrypt)

CREATE DATABASE IF NOT EXISTS micropsev2;
USE micropsev2;
...
-- (contrasena = bcrypt de "123456" para todos)
--
...
(1, 'Carlos', 'Martínez', '1012345678', 'carlos.martinez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3101234567', 1, '2026-05-04 17:01:47', 1),
(2, 'Ana', 'Rodríguez', '1023456789', 'ana.rodriguez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3112345678', 1, '2026-05-04 17:01:47', 1),
(3, 'Luis', 'García', '1034567890', 'luis.garcia@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3123456789', 1, '2026-05-04 17:01:47', 1),
(4, 'María', 'López', '1045678901', 'maria.lopez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3134567890', 0, '2026-05-04 17:01:47', 1),
(5, 'Jorge', 'Sánchez', '1056789012', 'jorge.sanchez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3145678901', 1, '2026-05-04 17:01:47', 0),
(6, 'Diana', 'Pérez', '1067890123', 'diana.perez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3156789012', 1, '2026-05-04 17:01:47', 1),
(7, 'Andrés', 'Ramírez', '1078901234', 'andres.ramirez@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3167890123', 1, '2026-05-04 17:01:47', 1),
(8, 'Laura', 'Torres', '1089012345', 'laura.torres@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3178901234', 1, '2026-05-04 17:01:47', 1),
(9, 'Ricardo', 'Flores', '1090123456', 'ricardo.flores@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3189012345', 0, '2026-05-04 17:01:47', 1),
(10, 'Sofía', 'Castro', '1101234567', 'sofia.castro@email.com', '$2b$12$XeSDEMQSBWWcO9Kli.5WbuVTyZIaVdVDkYWW.gHr4YPubUTRQON5u', '3190123456', 1, '2026-05-04 17:01:47', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `perfil`
-- (rol: cliente, asesor, administrador)
--

CREATE TABLE IF NOT EXISTS `perfil` (
  `id_usuario` int(11) NOT NULL,
  `foto` varchar(255) NOT NULL DEFAULT 'default_avatar.png',
  `nivel` varchar(30) DEFAULT 'basico',
  `rol` enum('cliente','asesor','administrador') NOT NULL DEFAULT 'cliente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `perfil` (`id_usuario`, `foto`, `nivel`, `rol`) VALUES
(1, 'default_avatar.png', 'avanzado', 'administrador'),
(2, 'default_avatar.png', 'intermedio', 'asesor'),
(3, 'default_avatar.png', 'basico', 'cliente'),
(4, 'default_avatar.png', 'basico', 'cliente'),
(5, 'default_avatar.png', 'intermedio', 'cliente'),
(6, 'default_avatar.png', 'avanzado', 'cliente'),
(7, 'default_avatar.png', 'basico', 'cliente'),
(8, 'default_avatar.png', 'intermedio', 'cliente'),
(9, 'default_avatar.png', 'basico', 'cliente'),
(10, 'default_avatar.png', 'avanzado', 'cliente');
...
ALTER TABLE `entidad_bancaria` MODIFY `id_banco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
ALTER TABLE `solicitud` MODIFY `id_solicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
ALTER TABLE `credito` MODIFY `id_credito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
ALTER TABLE `metodo_pago` MODIFY `id_metodo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
ALTER TABLE `pago` MODIFY `id_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
ALTER TABLE `estado_solicitud_log` MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
ALTER TABLE `notificacion` MODIFY `id_notificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
ALTER TABLE `prueba_virtual` MODIFY `id_prueba` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
